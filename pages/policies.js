  ...
  return (
    <Container>
      <div>
        ...
        <h4>Cancellations</h4>
        <ul>
          <li>Cancellations made within 14 days of your arrival date will forfeit your initial deposit.</li> 
        ...
        <ul>
          ...
          <li>Smoking is not permitted indoors. A $250 fee will be charged to your reservation cost.</li> 
